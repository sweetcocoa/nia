...
import torchaudio
from torchvision.models import resnet34, vgg16, mobilenet
...
class ResNet34(nn.Module):
    def __init__(self, model_config, pipe_config):
        ...
        self.model = resnet34(pretrained=model_config.pretrained)
...
def model(model_config, pipe_config):
    return ResNet34(model_config=model_config, pipe_config=pipe_config)
